...
public class ModernSearchBar: UISearchBar, UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        ///Configure Image
        cell.configureImage(choice: self.choice, searchImage: UIImage(), suggestionsListWithUrl: self.suggestionListWithUrlFiltred, position: indexPath.row, isImageRound: self.suggestionsView_searchIcon_isRound, heightImage: self.suggestionsView_searchIcon_height)
        ...
        cell.configureConstraints(heightImage: 35, widthImage: 35)
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("im here \(self.suggestionListWithUrlFiltred[indexPath.row].title)")
        print("im here \(self.suggestionListWithUrl[indexPath.row].title)")
