...
open class CheckboxDialogViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func showDialogView() {
        ...
        createOkButton()
        createStackView()
        self.okButton.setTitleColor(UIColor(rgb: 0xC1B46A), for: .normal)
    ...
    func createCancelButton() {
     ...
     //   cancelButton.layer.borderColor = UIColor.defaultDialogBorderColor().cgColor
        ...
        cancelButton.setTitleColor(UIColor(rgb: 0xC1B46A), for: .normal)
    ...
    func createOkButton() {
        ...
        okButton.setTitleColor(UIColor(rgb: 0xC1B46A), for: .normal)
    ...
    open func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("Im here")
        let object = tableData[indexPath.row]
        let cell = tableView.cellForRow(at: indexPath) as! CheckboxViewCell
        cell.backgroundColor = UIColor(rgb: 0xC1B46A)
